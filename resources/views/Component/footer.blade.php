<!-- Footer kontainer -->
    ...
    <footer class="footer py-4"
        style="background-color: #143C85; color: white; font-family: 'Arial', sans-serif; text-align: center;">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-lg-4">
                    <span
                        ...
                        AW
                        Mart</span><br>
                    <span style="font-family: 'Montserrat', sans-serif; font-size: 14px;">Jl. Setra Dago Raya No.8,
                        Antapani
    ...
    <!-- Footer kedua -->
    <footer class="footer py-4"
        style="background-color: #050E1F; color: white; font-family: 'Montserrat', sans-serif; text-align: center;" >
        <div class="container">
